 ...
 */
/* globals RigidRectangle, RigidShape */
"use strict";

/**
 *
 * @param {RigidRectangle} r1
 * @param {RigidRectangle} r2
 */
...
RigidRectangle.prototype.collided = function (otherShape) {
    ...
    switch (otherShape.rigidType()) {
        ...
        case RigidShape.eRigidType.eRigidRectangle:
            status = this.collidedRectRect(this, otherShape);
            break;
    }
    return status;
};
...
RigidRectangle.prototype.containsPos = function (pos) {
    ...
    return rMinX < pos[0] && rMaxX > pos[0] && rMinY < pos[1] && rMaxY > pos[1];
};