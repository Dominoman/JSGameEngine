...
gEngine.Fonts = (function () {
    ...
    var loadFont = function (fontName) {
        if (!gEngine.ResourceMap.isAssetLoaded(fontName)) {
            ...
            gEngine.TextFileLoader.loadTextFile(fontInfoSourceString, gEngine.TextFileLoader.eTextFileType.eXMLFile, _storeLoadedFont);
        } else {
    ...
    /**
     *
     * @param {string} fontInfoSourceString
     * @private
     */
